...
// 0x70.
static const u1_t PROGMEM APPEUI[8]={ 0xXX, 0xXX, 0x01, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        ...
        case EV_TXCOMPLETE:
            ...
            u8x8.drawString(0, 3, "EV_TXCOMPLETE");
            if (LMIC.txrxFlags & TXRX_ACK)
              Serial.println(F("Received ack"));
              u8x8.drawString(0, 4, "Received ack");
            if (LMIC.dataLen) {
              Serial.println(F("Received "));
              Serial.println(LMIC.dataLen);
              Serial.println(F(" bytes of payload"));
              u8x8.drawString(0, 4, "Received data : ");
               u8x8.setCursor(0, 5);
